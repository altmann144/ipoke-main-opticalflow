...
def parse():
    ...
    parser.add_argument('-c', '--config', default='config/BigGanAEImages.yaml', metavar='config_path')
...
if __name__ == '__main__':
    ...
    # Logger
    wandb_logger = WandbLogger(project='Fully Connected BigGAN Autoencoder Images',
    ...
    trainer = pl.Trainer(gpus=1, # int(1) = one gpu | [1] = '1' = gpu number 1
                         ...
                         default_root_dir='/export/home/daltmann/master_project/tmp/ipoke-main-opticalflow/scratch/FCAEModelImages'
                         )
    ...
    if not args.skip_save:
        trainer.save_checkpoint(f'scratch/FCAEModelImages_{z_dim}.ckpt')
