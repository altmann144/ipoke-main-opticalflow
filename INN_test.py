...
import yaml
from models.INN_experiment import FlowMotion
...
def parse():
    ...
    parser.add_argument('-c', '--config', default='config/INN_test.yaml', metavar='config_path')
...
if __name__ == '__main__':
    ...
    os.environ["WANDB_DIR"] = "/export/data/daltmann/INN_test"
    ...
    if (args.resume) or (input("start from scratch? (y,n) ") == 'y'): # make sure new initialization is wanted
        ...
        if not args.skip_save:
            trainer.save_checkpoint('wandb/INN_test.ckpt')
